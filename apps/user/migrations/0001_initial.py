    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment_number', models.PositiveSmallIntegerField(blank=True, null=True)),
        ...
        migrations.AddField(
            ...
            name='address',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='user.addressmodel'),
        ),
        migrations.AddField(
            model_name='baseusermodel',
            name='groups',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.contactperson')),
            ],
            options={

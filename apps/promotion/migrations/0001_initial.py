    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gift', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='promotion.gift', verbose_name='Подарок')),
                ('product', models.ManyToManyField(related_name='products', to='product.productmodel', verbose_name='товары по акции')),
            ],
            options={
                'verbose_name': 'Акция',
